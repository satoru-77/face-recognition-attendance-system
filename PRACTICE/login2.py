...
class Login:
    def __init__(self,root):
        ...
        # self.bg=ImageTk.PhotoImage(file=r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\loginBg1.jpg")
        ...
        Label(frame1, image = img, bg='white').place(x=0,y=0)

        frame_left = Frame(frame1, bg="blue") 
        frame_left.place(relx=0.2, rely=0.2, relwidth=0.3, relheight=0.5)
        

    

        # img1=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\log1.png")
        # img1=img1.resize((100,100),Image.LANCZOS)
        # self.photoimage1=ImageTk.PhotoImage(img1)
        # lb1img1 = Label(image=self.photoimage1,bg="#002B53")
        # lb1img1.place(x=690,y=175, width=100,height=100)

        get_str = Label(frame1,text="Login",font=("times new roman",20,"bold"),fg="red",bg="white")
        get_str.place(x=700,y=90)

        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="red",bg="white")
        username.place(x=600,y=160)

        #entry1 
        self.txtuser=ttk.Entry(frame1,font = ('Microsoft YaHei UI Light',17))
        self.txtuser.place(x=600,y=190,width=270)


        #label2 
        pwd =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="red",bg="white")
        pwd.place(x=600,y=230)

        #entry2 
        self.txtpwd=ttk.Entry(frame1,font=("times new roman",15,"bold"))
        self.txtpwd.place(x=600,y=260,width=270,height=40)
        ...
        loginbtn.place(x=600,y=320,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",12,"bold"),bd=0,relief=RIDGE,fg="red",bg="white",activeforeground="orange",activebackground="#002B53")
        loginbtn.place(x=600,y=370,width=80,height=30)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",12,"bold"),bd=0,relief=RIDGE,fg="red",bg="white",activeforeground="orange",activebackground="#002B53")
        loginbtn.place(x=700,y=370,width=80,height=30)
...
# This part is image labels setting start 
        ...
        # backgorund image 
        # bg1=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\std1.jpg")
        std_img_btn=std_img_btn.resize((180,180),Image.LANCZOS)
        self.std_img1=ImageTk.PhotoImage(std_img_btn)

        std_b1 = Button(bg_img,command=self.student_pannels,image=self.std_img1,cursor="hand2")
        std_b1.place(x=130,y=100,width=180,height=180)
        ...
        std_b1_1.place(x=130,y=280,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\det1.jpg")
        det_img_btn=det_img_btn.resize((180,180),Image.LANCZOS)
        self.det_img1=ImageTk.PhotoImage(det_img_btn)

        det_b1 = Button(bg_img,command=self.face_rec,image=self.det_img1,cursor="hand2",)
        det_b1.place(x=400,y=100,width=180,height=180)

        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=400,y=280,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\att.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\qr1.png")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\exit.png")
